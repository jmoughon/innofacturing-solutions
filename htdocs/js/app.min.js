    ...
    Foundation.libs.accordion = {
        ...
        events: function() {
            ...
            S(this.scope).off(".fndtn.accordion").on("click.fndtn.accordion", "[" + this.attr_name() + "] > dd > a", function(e) {
                var accordion = S(this).closest("[" + self.attr_name() + "]"), groupSelector = self.attr_name() + "=" + accordion.attr(self.attr_name()), settings = accordion.data(self.attr_name(true) + "-init"), target = S("#" + this.href.split("#")[1]), aunts = $("> dd", accordion), siblings = aunts.children("." + settings.content_class), active_content = siblings.filter("." + settings.active_class);
                e.preventDefault();
...
(function($, window, document, undefined) {
    ...
    Foundation.libs.slider = {
        ...
        set_initial_position: function($ele) {
            var settings = $.data($ele.children(".range-slider-handle")[0], "settings"), initial = !!settings.initial ? settings.initial : Math.floor((settings.end - settings.start) * .5 / settings.step) * settings.step + settings.start, $handle = $ele.children(".range-slider-handle");
...
function parallax() {
    ...
    $(".billboard").css("background-position", "center " + -(scrolled * .15) + "px");
}